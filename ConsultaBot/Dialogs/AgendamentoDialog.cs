...
namespace ConsultaBot.Dialogs
{
    ...
    public class AgendamentoDialog : LuisDialog<object>
    {
        [LuisIntent("None")]
        ...
        {
            var endpoint = "https://consultarexames20180227092808.azurewebsites.net/api/Exames/getPreparo/{result.Query}";
            ...
            using (var client = new HttpClient())
            {
                ...
                {
                    await context.PostAsync("Ocorreu alugum erro... Tente mais tarde");
                    return;
                }
                else
                {
